...
Identify the openbao address by setting the `BAO_ADDR` environment variable using the OpenBao URL which is we fetched from the relation data earlier

```bash
export BAO_ADDR="https://<your hostname>"
```
