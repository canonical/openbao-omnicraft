# Key differences between OpenBao charm version 1.8 and 1.15

Versions 1.8 (and below) and 1.15 (and beyond) are fundamentally different charms. Here is a list of additions, changes and removals made to the OpenBao charm 1.15, when compared with 1.8.

## Additions

- Act as an intermediate CA (see [How-to: use as an intermediate CA](../how-to/use_as_intermediate_ca.md)
- Auto unseal using a root unsealer OpenBao (see [How-to: Configure for Auto unseal](../how-to/configure_for_autounseal.md)
...
- Storage backend: The OpenBao charm now supports the Raft backend and drops support for other backends. Raft provides High Availability by default (see [Explanation: High Availability](../explanation/ha.md).
...
Upgrading from 1.8 to 1.15 is not supported, however you can backup your data on 1.8, and restore it on a new deployment of OpenBao 1.15.
